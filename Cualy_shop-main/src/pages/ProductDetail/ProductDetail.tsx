...
const ProductDetail = () => {
  useEffect(() => {
    console.log("Cualy Shop: ProductDetail component mounted");
  }, []);
  ...
  useEffect(() => {
    ...
    return () => {
      delete (window as any).cualyShop;
    };
  }, [product, handleAddToCart, handleWhatsAppInquiry]);

  if (loading) return <div className="loadingContainer"><Loader2 className="animate-spin" size={48} color="#00AEEF" /></div>;
