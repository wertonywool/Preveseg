...
const THANK_YOU_MESSAGES = [
  ...
  "¡Es oficial! Ya tienes lo mejor en tecnología. Gracias por elegir Cualy Shop para tu {producto}.",
  "Tu preferencia nos impulsa a seguir mejorando. ¡Disfruta tu {producto}!",
  "¡Qué gran elección! El {producto} es de nuestros favoritos. Gracias por tu compra.",
  "Gracias por permitirnos ser parte de tu experiencia tecnológica con este {producto}."
];

const COLORS = [
  { name: 'Cualy Blue', hex: '#00AEEF' },
  { name: 'Elite Black', hex: '#0f172a' },
  { name: 'Success Green', hex: '#10b981' },
  { name: 'Passion Red', hex: '#ef4444' },
        ...
        <header className="master-header">
          <div className="master-logo-group">
            ...
            <div className="master-brand-info">
              <span className="master-brand-name">CUALY SHOP</span>
              <div className="master-tagline">TECNOLOGÍA A TU ALCANCE</div>
            </div>
          </div>
        ...
        <footer className="master-footer">
          <div className="contact-blocks">
            <div className="c-block">
              ...
              <div className="c-val"><Phone size={22} color={accentColor} /> +57 318 902 9468</div>
            </div>
            <div className="c-block">
              <div className="c-title">Nuestra Comunidad</div>
              <div className="social-grid">
                <div className="s-item"><Instagram size={22} color={accentColor} /> @cualy_shop</div>
                <div className="s-item"><Globe size={22} color={accentColor} /> cualy-shop.com</div>
              </div>
            </div>
          </div>
      ...
      <div className="no-print generator-container-v2">
        {!isSubComponent && (
          <header className="v2-header">
            <button onClick={() => navigate('/wertonywool')} className="v2-back">
