...
const MESSAGES = [
  ...
  "¡Es oficial! Ya tienes lo mejor en tecnología. Gracias por elegir Cualy Shop para {productos}.",
  ...
  "Gracias por permitirnos ser parte de tu experiencia tecnológica con {productos}."
];
      ...
      <div className="no-print qr-admin-layout">
        ...
        <aside className="qr-sidebar-panel animate-in">
          <div className="sidebar-header">
            {!isSubComponent && (
              <button onClick={() => navigate('/wertonywool')} className="qr-back-link">
                <ArrowLeft size={18} /> Volver al Panel
              </button>
            )}
            <h2><span>Cualy</span> Supreme</h2>
